<template>
    <div class="userManage-container">
        ...
        <div class="router-view">
            <vUserManage class="v-user-manage"></vUserManage>
        </div>
...
<script>
    import vHeader from '../../../components/trafficConn/header/header.vue';
    import vFooter from '../../../components/layout/footer/footer.vue';
    import vUserManage from '../../../components/trafficConn/trafficConn.vue';
    export default {
        data () {
            return {}
        },
