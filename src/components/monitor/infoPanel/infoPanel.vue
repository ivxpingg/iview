    ...
    <div class="infoPanel-container">
        ...
        <div class="left-panel">
            <div class="bg">
                ...
                <div class="bg-bg"></div>
                <div class="bg-bg-extra"></div>
                <div class="bg-join bg-join1"></div>
                <div class="bg-bg">
                </div>
                <div class="bg-join bg-join2"></div>
                <div class="bg-bg">
                </div>
        ...
        <div class="right-panel">
            ...
            <div class="info-panel">
                <div class="top">
                    <span class="text">平均发班间隔</span>
                </div>
                <div class="bottom">
                    <div class="box box-1">
                        <div class="title">早高峰</div>
                        <div class="value-panel">
                            <div class="value"><span>上行:</span><span class="num">{{datas.upEarlyAverageClass}}</span></div>
                            <div class="value"><span>下行:</span><span class="num">{{datas.downEarlyAverageClass}}</span></div>
                        </div>
                    </div>
                    <div class="box box-2">
                        <div class="title">平峰</div>
                        <div class="value-panel">
                            <div class="value"><span>上行:</span><span class="num">{{datas.upFlatAverageClass}}</span></div>
                            <div class="value"><span>下行:</span><span class="num">{{datas.downFlatAverageClass}}</span></div>
                        </div>
                    </div>
                    <div class="box box-3">
                        <div class="title">晚高峰</div>
                        <div class="value-panel">
                            <div class="value"><span>上行:</span><span class="num">{{datas.upLateAverageClass}}</span></div>
                            <div class="value"><span>下行:</span><span class="num">{{datas.downLateAverageClass}}</span></div>
                        </div>
                    </div>
                    <div class="box box-4">
                        <div class="title">夜间</div>
                        <div class="value-panel">
                            <div class="value"><span>上行:</span><span class="num">{{datas.upNightAverageClass}}</span></div>
                            <div class="value"><span>下行:</span><span class="num">{{datas.downNightAverageClass}}</span></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        .left-panel {
            ...
            .bg {
                ...
                .bg-left {
                    width: 33px;
                    height: 100%;
                    background: transparent url(./images/bg1-left.png) no-repeat center;
                }

                .bg-join {
                    width: 41px;
                    height: 100%;
                    background: transparent url(./images/bg1-join.png) no-repeat center;
                }

                .bg-right {
                    width: 39px;
                    height: 100%;
                    background: transparent url(./images/bg1-right.png) no-repeat center;
                }

                .bg-bg {
                    flex: 1;
                    height: 100%;
                    background: transparent url(./images/bg1-bg.png) repeat-x center;
                }
                .bg-bg-extra {
                    width: 8px;
                    height: 100%;
